...
namespace DomainTests
{
    ...
    public class DomainContractTests : IClassFixture<CheckpointFixture<DomainContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public DomainContractTests(CheckpointFixture<DomainContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("DomainTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<DomainContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<DomainContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<DomainContract>();
            var contractStorage = storages.StorageMap("DomainContract");
