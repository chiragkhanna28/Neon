...
namespace SaveGetTests
{
    ...
    public class SaveGetContractTests : IClassFixture<CheckpointFixture<SaveGetContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public SaveGetContractTests(CheckpointFixture<SaveGetContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("SaveGetTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<SaveGetContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<SaveGetContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<SaveGetContract>();
            var contractStorage = storages.StorageMap("SaveGetContract");
